...
export default function EditStudent() {
    ...
    return (
        <>
            <BurgerMenu />
            <VerticalNav />
            <div className="edit-news-page bg-slate-200 min-h-svh pt-24 lg:pt-[13px] lg:pr-32 pb-5">
                <div className="edit-news-form-container bg-white rounded-lg shadow-lg max-w-[85svw] p-5 relative lg:mx-0 mx-auto">
                    <HeadingSign />
                    <h1 className="text-base sm:text-lg font-bold text-gray-700">
                        ویرایش اطلاعات خبر
                    </h1>
                    <form className="edit-news-form flex flex-col items-center mx-auto w-[80%] mt-12">
                        {/* edit image */}
