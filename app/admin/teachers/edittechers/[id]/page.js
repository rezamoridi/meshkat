...
export default function EditStudent() {
    ...
    return (
        <>
            <BurgerMenu />
            <VerticalNav />
            <div className="edit-teacher-page bg-slate-200 min-h-svh pt-24 lg:pt-[13px] lg:pr-32 pb-5">
                <div className="edit-teacher-form-container bg-white rounded-lg shadow-lg max-w-[85svw] p-5 relative lg:mx-0 mx-auto">
                    <HeadingSign />
                    <h1 className="text-base sm:text-lg font-bold text-gray-700">
                        ویرایش اطلاعات حساب استاد
                    </h1>
                    <form className="edit-teacher-form flex flex-col items-center mx-auto w-[80%] mt-12">
                        {/* edit image */}
                        <div className="col w-full flex justify-center">
                            <div className="input-container relative w-36 h-36 bg-cyan-600/70 rounded-md cursor-pointer overflow-hidden group">
                                ...
                                <span className="absolute group pointer-events-none flex justify-center w-full p-2 text-white bg-gray-400/50 -bottom-10 transition-all duration-300 group-hover:bottom-0">
                                    <FaPen />
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="row flex flex-wrap w-full mt-10 lg:mt-12">
                            ...
                            {/* edit deg */}
                            {/* edit role */}
                            <div className="col w-full md:2-1/2 lg:w-1/3 p-3">
                                <div className="input-container w-full relative ">
                                    <select className="outline-none w-full border-2 border-cyan-600/30 rounded-md p-2 h-11 text-gray-400">
                        ...
                        <button className="bg-cyan-600/50 transition duration-300 hover:bg-cyan-600/70 mt-7 px-5 py-2 rounded-md text-white">
                            ویرایش اطلاعات
                        </button>
                    </form>
                </div>
