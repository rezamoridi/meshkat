...
export default function EditEvent() {
    ...
    return (
        <>
            <div className="edit-event bg-slate-100 h-dvh flex justify-center">
                <BackBtn link={'/admin/events'} />
                <div className="edit-event-form-container bg-white rounded-lg shadow-lg h-[70svh] w-1/3 mt-28 p-5">
                    <form className="rounded-lg flex flex-col justify-center items-center">
                        ...
                        <button className="bg-cyan-600/50 transition duration-300 hover:bg-cyan-600/70 mt-1 px-5 py-2 rounded-md text-white">ویرایش رویداد</button>
                    </form>
                </div>
            </div>
        </>
